...
class MongoClient:
    ...
    async def log_deregistration(self, deregistration_query: DeregistrationQuery):
    ...
    async def deregister(self, deregistration_query: DeregistrationQuery):
    ...
    async def clear(self, clear_query: ClearQuery):
