...
@pytest.mark.parametrize("hook_data, missing_key", [
    ...
    ({'comment': {'body': 'Triggear resync sha'}}, 'repository'),
    ({'comment': {'body': 'Triggear run test'}, 'repository': {}}, 'full_name'),
    ({'comment': {'body': 'Triggear resync sha'}, 'repository': {}}, 'full_name'),
    ({'comment': {'body': 'Triggear run test'}, 'repository': {'full_name': 'test_repo'}}, 'issue'),
    ({'comment': {'body': 'Triggear resync sha'}, 'repository': {'full_name': 'test_repo'}}, 'issue'),
    ({'comment': {'body': 'Triggear run test'}, 'repository': {'full_name': 'test_repo'}, 'issue': {}}, 'number'),
    ({'comment': {'body': 'Triggear resync sha'}, 'repository': {'full_name': 'test_repo'}, 'issue': {}}, 'number'),
    ({'comment': {'body': 'Triggear resync sha'},
